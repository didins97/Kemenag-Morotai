<footer class="bg-gradient-to-b from-green-800 to-green-900 text-white py-12">
    <div class="container mx-auto px-6">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <!-- Logo and Social -->
            <div class="space-y-4">
                <div class="flex items-center justify-center md:justify-start space-x-3">
                    <img src="{{ asset('assets') }}/img/logokemenag.png" alt="Kemenag Logo" class="h-10">
                    <h3 class="text-lg font-bold">KEMENAG MOROTAI</h3>
                </div>
            ...
            <!-- Quick Links -->
            <div class="space-y-4">
                <h3 class="text-lg font-bold text-center md:text-left">Tautan Cepat</h3>
                <ul class="space-y-2 text-sm text-gray-300 text-center md:text-left">
                    <li><a href="#" class="hover:text-yellow-300 transition-colors">Beranda</a></li>
                    <li><a href="#" class="hover:text-yellow-300 transition-colors">Profil</a></li>
                    <li><a href="#" class="hover:text-yellow-300 transition-colors">Layanan</a></li>
                    <li><a href="#" class="hover:text-yellow-300 transition-colors">Berita</a></li>
                </ul>
            </div>

            <!-- Contact -->
            <div class="space-y-4">
                <h3 class="text-lg font-bold text-center md:text-left">Kontak</h3>
                <ul class="space-y-2 text-sm text-gray-300 text-center md:text-left">
                    <li class="flex items-center justify-center md:justify-start">
                        ...
                        Jalan Raya Daruba, Kecamatan Morotai Selatan, Kabupaten Pulau Morota
                    </li>
                    <li class="flex items-center justify-center md:justify-start">
                        <svg class="w-4 h-4 mr-2 text-yellow-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
